...
console.log(Object.keys(myObject)); // Output: [] (Symbols are not part of enumerable keys)
console.log(Object.getOwnPropertySymbols(myObject)); // Output: [ Symbol(uniqueProperty), Symbol(uniqueProperty) ]
